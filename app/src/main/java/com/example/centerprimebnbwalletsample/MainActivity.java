...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding.checkERCTokenkBalance.setOnClickListener(v -> { startActivity(new Intent(MainActivity.this, CheckBEP20TokenBalanceActivity.class)); });
        binding.sendERCToken.setOnClickListener(v -> { startActivity(new Intent(MainActivity.this, SendBEP20TokenActivity.class)); });
